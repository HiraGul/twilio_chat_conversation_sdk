...
public class Methods {
    ...
    public final static String unSubscribeToTypingUpdate = "unSubscribeToTypingUpdate";
    public final static String subscribeToTypingUpdate = "subscribeToTypingUpdate";
}
