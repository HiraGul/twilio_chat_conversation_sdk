...
abstract class TwilioChatConversationPlatform extends PlatformInterface {
  ...
  Future<String?> subscribeToTypingUpdate({required String conversationId}) {
    throw UnimplementedError('platformVersion() has not been implemented.');
  }

  Future<String?> unSubscribeToTypingUpdate({required String conversationId}) {
    throw UnimplementedError('platformVersion() has not been implemented.');
  }
  ...
  Future<String?> startTyping({required conversationId}) {
    throw UnimplementedError('platformVersion() has not been implemented.');
  }

  Future<String?> stopTyping({required conversationId}) {
    throw UnimplementedError('platformVersion() has not been implemented.');
  }
}
